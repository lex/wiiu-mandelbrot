...
void drawPixel(int x, int y, char r, char g, char b, char a) {
    ...
    // Code to write to framebuffer directly. For some reason this is only
    // writing to one of the framebuffers when calling flipBuffers. Should
    // provide speedup but needs investigation.
    /*
    int buf0_size = OSScreenGetBufferSizeEx(0);
    int height = 1024;
    int width = 1280;
...
void drawFillRect(int x1, int y1, int x2, int y2, char r, char g, char b,
                  char a) {
    int X1, X2, Y1, Y2, i, j;
...
void drawCircle(int xCen, int yCen, int radius, char r, char g, char b,
                char a) {
    int x = 0;
    int y = radius;
    int p = (5 - radius * 4) / 4;
...
void drawFillCircle(int xCen, int yCen, int radius, char r, char g, char b,
                    char a) {
...
void drawCircleCircum(int cx, int cy, int x, int y, char r, char g, char b,
                      char a) {
